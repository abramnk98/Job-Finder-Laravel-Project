...
<div class="unit-5 overlay" style="background-image: url('{{asset('assets/images/hero_1.jpg')}}');">
    <div class="container text-center">
        ...
        <p class="mb-0 unit-6"><a href="{{route('home')}}">Home</a> <span class="sep">></span> <span>Post a Job</span></p>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-lg-8 mb-5">
                ...
                <form action="{{route('jobs.store')}}" method="post" class="p-5 bg-white" enctype="multipart/form-data">

                    @csrf
                    <div class="row form-group">
                        <div class="col-md-12 mb-3 mb-md-0">
                            <label class="font-weight-bold" for="job_title">Job Title</label>
                            <input type="text" id="job_title" class="form-control" name="job_title" placeholder="eg. Full Stack Frontend">
                            @error('job_title')
                    ...
                    <div class="row form-group">
                        <div class="col-md-12 mb-3 mb-md-0">
                            ...
                            <input type="text" id="company_name" class="form-control" name="company_name" placeholder="{{Auth::user()->employeeProfile->company_name}}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-12 mb-3 mb-md-0">
                            <label for="option-job-type-1">
                                <input type="radio" id="option-job-type-1" name="job_type" value="Freelance">
                                Freelance
                            </label>
                        </div>
                        <div class="col-md-12 mb-3 mb-md-0">
                            <label for="option-job-type-1">
                                <input type="radio" id="option-job-type-1" name="job_type" value="Full Time">
                                Full Time
                            </label>
                        </div>
                        <div class="col-md-12 mb-3 mb-md-0">
                            <label for="option-job-type-1">
                                <input type="radio" id="option-job-type-1" name="job_type" value="Part Time">
                                Part Time
                            </label>
                        </div>
                        @error('job_type')
